/**
 *  Activate A Routine When Switch Turns On
 *
 ...
 */
definition(
    name: "Activate a Routine when Switch Turns On",
    namespace: "sbdobrescu",
    author: "Bobby Dobrescu",
    description: "Fire a routine everytime a switch turns on.",
...
preferences {
    ...
    section("Perform the following phrase when this switch turns on...") {
				log.trace phrases
				input "phrase_on", "enum", title: "Select switch", required: true, options: phrases
			}
}
