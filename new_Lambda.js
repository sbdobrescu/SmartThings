...
exports.handler = function( event, context ) {
   ...
   var IName = 'my home';
   var STappID = '7775fd8d-4657-4a73-b087-0f8a229727b8';
   var STtoken = 'b875578c-64ae-40c1-b854-fd2c63c7f578';
   ...
   if (event.request.type == "LaunchRequest") {
        ...
        if (intentName == "DeviceOperation") {
            ...
            output(resText, context, "SmartThings Alexa Yes Command", true);
        }
        ...
        if (!process) {
            ...
            https.get( url, function( response ) {
                ...
                console.log(speechText);
                    ...
                    speechText = speechText + ' , Do you need Anything else?';
                	endSession = false;
...
function output( text, context, card, endSession ) { 
   var response = {
      outputSpeech: {
         type: "PlainText",
         text: text
